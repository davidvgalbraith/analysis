...
\newcommand{\homrmn}{\text{Hom}_R(M, N)}
\newcommand{\multilinear}[1]{(x_1, x_2, \ldots, #1, \ldots, x_n)}
\newcommand{\spn}{\text{span}}
\newcommand{\xton}{x_1, \ldots x_n}
\newcommand{\kd}{K_d[\xton]}
\newcommand{\kn}{K[\xton]}
\newcommand{\kds}{K_d^S[\xton]}
\newcommand{\ks}{K^S[\xton]}
\newcommand{\rn}{\reals^n}
\newcommand{\stab}{\text{Stab}}
\newcommand{\degrees}{^\circ}
\newcommand{\fre}{\forall \epsilon > 0 \exists}
\newcommand{\fred}{\fre \delta > 0 :}
